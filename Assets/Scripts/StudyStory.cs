...
public class StudyStory : MonoBehaviour
{
    ...
    public void SoloCoding(DialogController dialogController)
    {
        dialogController.ShowTexts(0.5f, 1.5f, 0.02f, "스스로 학습하기로 했다", "...\n...\n...", "열심히 코딩을 했다!", "코딩 레벨 +1 \n스트레스 +10");
        Invoke("NextButton", 0.5f);
    }

    public void DuoCoding(DialogController dialogController)
    {
        dialogController.ShowTexts(0.5f, 1.5f, 0.02f, "동료와 함께 코딩학습을 했다", "...\n...\n...", "많은 것을 배웠다!", "코딩레벨 +1 \n동료와의 관계 +5 \n스트레스 +10");
        Invoke("NextButton", 0.5f);
    }

    public void Evaluate(DialogController dialogController)
    {
    ...
    public void Evaluted(DialogController dialogController)
    {
        int situation = Random.Range(0, 5);
        switch (situation)
        {
    ...
    public void Cheating(DialogController dialogController)
    {
